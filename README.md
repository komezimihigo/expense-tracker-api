...
```bash
git checkout -b david-controller
```
...
```bash
git add .
git commit -m "Implemented expense controller"
```

Push the branch

```bash
git push origin david-controller
```
...
This project is for educational purposes as part of a university group assignment.
